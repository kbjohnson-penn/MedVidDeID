...
For developer guidelines, see [CLAUDE.md](CLAUDE.md) which contains build commands and code style guidelines.

## Citation

If you use MedVidDeID in your research, please cite our components:

```bibtex
@misc{medviddeid2023,
  author = {Sriharsha Mopidevi and Contributors},
  title = {MedVidDeID: A Modular Pipeline for Medical Audio-Visual De-Identification},
  year = {2023},
  publisher = {GitHub},
  url = {https://github.com/kbjohnson-penn/MedVidDeID}
}
```
